    ...
    return (
      <Link href={`/events/${event.id}`}>
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="group relative overflow-hidden rounded-2xl cursor-pointer hover:-translate-y-1.5 hover:scale-[1.01] transition-transform duration-150 ease-out"
          style={{ minHeight: 420 }}
        >
          {/* Gradient image area */}
          <div
  ...
  return (
    <Link href={`/events/${event.id}`}>
      <motion.div
        ...
        className="group relative glass neon-border rounded-2xl overflow-hidden cursor-pointer hover:border-[#ea6390]/40 hover:-translate-y-1 transition-[transform,box-shadow,border-color] duration-150 ease-out"
      >
        {/* Image area */}
