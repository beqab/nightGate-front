...
const lineupMap: Record<string, LineupArtist[]> = {
  "evt-001": [
    {
      name: "BLAWAN",
      role: "Techno · Industrial · Headliner",
      time: "03:00–07:00",
      isHeadliner: true,
    },
    {
      name: "SPECIAL GUEST TBA",
      role: "Dark Techno · Support",
      time: "02:00–03:00",
    },
  ...
  "evt-002": [
    {
      name: "NINA KRAVIZ",
      role: "Deep House · Disco · Headliner",
      time: "01:00–04:00",
      isHeadliner: true,
    },
  ...
  "evt-004": [
    {
      ...
      role: "Techno · Electronic · Headliner",
      time: "04:00–08:00",
      isHeadliner: true,
    },
  ...
  "evt-006": [
    {
      name: "J BALVIN",
      role: "Reggaeton · Latin · Headliner",
      time: "01:00–05:00",
      isHeadliner: true,
    },
    {
      name: "SALSA FRIENDS",
      role: "Salsa · Merengue · Support",
      time: "00:00–01:00",
    },
  ...
  "evt-007": [
    {
      name: "APHEX TWIN",
      role: "Experimental · Minimal · Headliner",
      time: "03:00–07:00",
      isHeadliner: true,
    },
    {
      name: "BURIAL",
      role: "Dubstep · Ambient · Support",
      time: "01:30–03:00",
    },
  ...
  "evt-008": [
    {
      name: "BLACK COFFEE",
      role: "Afro House · Deep · Headliner",
      time: "00:00–04:00",
      isHeadliner: true,
    },
